...
const Navbarnew = () => {
  ...
  return (
    <React.Fragment>
      {location.pathname !== "/" && location.pathname !== "/LoginMobileResFromSignup"&&location.pathname !== "/LoginMobileResDirectSecond"&&location.pathname !== "/signup" && (
            ...
            <>
              ...
              >
                <Stack direction="row" alignItems="center">
                  ...
                  <Typography variant="body2"  color={"black"}>Logout</Typography>
                </Stack>
              </StyledButton>
              </Stack>
