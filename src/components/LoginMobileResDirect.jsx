  ...
  const onSubmit = async (data) => {
    ...
    try {
      ...
      if (response.data.success) {
        ...
        //  navigate('/', { state: { mobilenumber: data.mobilenumber } });


        //  const queryString = `?user_identifier=${data.mobilenumber}`;
        //  navigate('/', { search: queryString });
        
        // Navigate to the home page ("/home") with the mobile number as a query parameter
...
export default LoginMobileResDirect;
