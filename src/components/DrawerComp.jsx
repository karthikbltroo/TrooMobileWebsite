...
const pages = ['Candidates', 'ManageMaster', 'Roles', "Requests", "Request Candidate", "profile", "account", "logout"]
const DrawerComp = () => {
 ...
 width="50.000000pt" height="50.000000pt" viewBox="0 0 1316.000000 470.000000"
...
332 -1256 0 c-691 0 -1258 -2 -1260 -4z"/>
         ...
         <Box style={{alignItem:'center', justifyContent:'center', margin:'10px auto'}} >
