...
import { BrowserRouter as Router, Routes, Route, Link, Outlet ,useNavigate,
  ...
  return (
    ...
    <Navbarnew/> 
      ...
      <Routes>
        ...
        <Route path="/LoginMobileResFromSignup" element={<LoginMobileResSignup />} />
        <Route path="/LoginMobileResDirectSecond" element={<LoginMobileResDirectSecond />} />
